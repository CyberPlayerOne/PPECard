...
namespace CustomUIControls
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
        ...
        public string CurrentUserIpString;
        //以下两行以及Show函数里的跨线程操作if else语句为我加的，以用于非主线程中的使用：
        public delegate void ShowCallback(string strTitle, string strContent, int nTimeToShow, int nTimeToStay, int nTimeToHide);
        ...
        private void InitializeComponent()
        {
            ...
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.TaskbarNotifier_FormClosed);
            this.ResumeLayout(false);

        }

        private void TaskbarNotifier_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose();
            GC.Collect();
        }
